...
<ul id="sideManu" class="nav nav-tabs nav-stacked">
	<li class="subMenu open"><a> ELECTRONICS [230]</a>
		<ul>
			<li><a class="active" href="products"><i
					class="icon-chevron-right"></i>Cameras (100) </a></li>
			<li><a href="products"><i class="icon-chevron-right"></i>Computers,
					Tablets & laptop (30)</a></li>
			<li><a href="products"><i class="icon-chevron-right"></i>Mobile
					Phone (80)</a></li>
			<li><a href="products"><i class="icon-chevron-right"></i>Sound
					& Vision (15)</a></li>
		</ul></li>
